        ...
        try {
            mailer.send(
                    Mail.withText(toEmail,
                            ...
                            "Dear " + names + "!\n" +
                                    "\n" +
                                    "You've requested to reset password to BDF Attendance System, " +
        ...
        try {
            mailer.send(
                    Mail.withText(toEmail,
                            ...
                            "Dear " + names + "!\n" +
                                    "\n" +
                                    "You've successfully reset your password to BDF Attendance System. \n" +
                                    "\n" +
        ...
        try {
            ...
            mailer.send(
                    Mail.withText(
                            ...
                            "Dear " + names + "!\n" +
                                    "\n" +
                                    "You've requested to verify your email to BDF Attendance System, " +
        ...
        try {
            mailer.send(
                    Mail.withText(toEmail,
                            ...
                            "Dear " + names + "!\n" +
                                    "\n" +
                                    "You've successfully verified your email to BDF Attendance System. \n" +
                                    "\n" +
                                    "If you have any questions, send us an email"
                    ));
        } catch (Exception e) {
        ...
        try {
            ...
            mailer.send(
                    Mail.withText(toEmail,
                            ...
                            "Dear " + names + "!\n" +
                                    "\n" +
                                    "Welcome to BDF Attendance System. \n" +
                                    "\n" +
                                    "If you have any questions, send us an email"
                    ));
        } catch (Exception e) {
